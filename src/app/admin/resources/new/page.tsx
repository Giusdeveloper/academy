...
import { ResourceType, ResourceCategory, DifficultyLevel, Language } from '@/types/resources';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(data.error || 'Errore nella creazione risorsa');
      }
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <h1 className="text-3xl font-bold text-gray-900">Nuova Risorsa</h1>
        <Link
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="md:col-span-2">
            ...
            <input
              ...
              placeholder="Es: Guida Completa al Finanziamento Aziendale"
            />
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-pink-500 focus:border-transparent"
              placeholder="Es: finanziamento, startup, guida"
            />
        ...
        <div className="flex items-center justify-end space-x-4 pt-4 border-t">
          ...
          >
            {loading ? 'Salvataggio...' : 'Salva Risorsa'}
          </button>
        </div>
      </form>
    </div>
